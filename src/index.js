	...
	render(){
		...
		const sideNav = (
			<SideNav
			  ...
			  />
			  <SideNavItem waves icon='bar_chart' onClick={() => this.mostrarPreguntas()}>Consultar Datos</SideNavItem>
			  <SideNavItem waves icon='publish' onClick={() => this.mostrarTraductorDatos()}>Insertar Datos</SideNavItem>
			</SideNav>
);
