...
class SelectedPage extends React.Component {
  ...
  render() {
    ...
    const navBarTitle = preguntasSelected
    ...
    const sideNav = (
      <SideNav
        trigger={
          <Button className="button-collapse show-on-medium-and-up btn-flat white-text">
      ...
      >
        ...
        <SideNavItem
          waves
          icon="publish"
          onClick={() => this.mostrarTraductorDatos()}
        >
          Insertar Datos
        </SideNavItem>
      </SideNav>
      ...
      return (
        <div>
          <div className="navBar">
            <nav className={navColor}>{navBar}</nav>
          </div>
          {queries}
          {datos}
        </div>
...
ReactDOM.render(<SelectedPage />, document.getElementById("root"));
